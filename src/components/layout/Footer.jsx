...
const CERTIFICATION_KEYS = ["iata", "traveltech", "ssl", "partner"];
...
function Footer() {
  ...
  return (
    <footer className="relative mt-20 border-t border-white/10 bg-slate-950/90 backdrop-blur-xl">
      ...
      <Container className="relative py-12 sm:py-14 lg:py-16">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-slate-400/95">{t("footer_location")}</p>
