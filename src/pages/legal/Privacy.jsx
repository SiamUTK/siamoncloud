      ...
      <div className="max-w-4xl mx-auto px-4">
        <header className="mb-10">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm">
            {t("legal.privacy.lastUpdated", { date: LAST_UPDATED })}
          </p>
        </header>
